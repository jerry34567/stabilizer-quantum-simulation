...
/// Opid of mtbdd_apply_gate_x needed for operation caching
extern uint64_t mtbdd_apply_gate_x_id;

/// Opid of mtbdd_apply_gate needed for operation caching
extern uint64_t mtbdd_apply_gate_id;

/// Opid of mtbdd_apply_cx_gate needed for operation caching
extern uint64_t mtbdd_apply_cx_gate_id;

/// Opid of mtbdd_apply_ccx_gate needed for operation caching
extern uint64_t mtbdd_apply_ccx_gate_id;

/// Opid of mtbdd_apply_cz_gate needed for operation caching
extern uint64_t mtbdd_apply_cz_gate_id;

/// Opid of mtbdd_apply_ccz_gate needed for operation caching
extern uint64_t mtbdd_apply_ccz_gate_id;
...
TASK_DECL_2(MTBDD, mtbdd_div_root2, MTBDD, size_t);
/**
 * Computes t / √2 for a cnum MTBDD
 * 
 * @param t an MTBDD
 * 
 * @param c unsigned integer (the multiplication coefficient)
 * 
 */
#define my_mtbdd_div_root2(t) mtbdd_uapply(t, TASK(mtbdd_div_root2), 0)

TASK_DECL_2(MTBDD, mtbdd_div_2, MTBDD, size_t);
/**
 * Computes t / 2 for a cnum MTBDD
 * 
 * @param t an MTBDD
 ...
 * 
 */
#define my_mtbdd_div_2(t) mtbdd_uapply(t, TASK(mtbdd_div_2), 0)
